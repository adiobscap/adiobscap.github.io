// app/careers/[slug]/apply/ApplyForm.tsx
//
// Client component that owns the apply-form state and the Supabase
// submission. The parent (server) page reads the slug from params,
// looks up the job title, and passes both as props.
'use client';
...
export default function ApplyForm({ slug, positionTitle }: ApplyFormProps) {
